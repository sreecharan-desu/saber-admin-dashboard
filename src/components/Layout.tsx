        ...
        <div className="wrapper h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <h1 className="font-extrabold text-xl tracking-tighter uppercase italic text-black">
                saber
              </h1>
            </Link>

            <span className="text-gray-200 text-xl font-thin select-none">
              /
            </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xs text-gray-500 tracking-tight">
                {user.name}
              </span>
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-3 w-60 bg-white border border-gray-100 rounded-xl shadow-xl z-50 py-1 animate-in fade-in slide-in-from-bottom-2">
                  ...
                  <div className="py-2">
                    <Link
                      to="/profile"
                      className="flex items-center gap-3 px-4 py-2 text-sm text-gray-500 hover:text-black hover:bg-gray-50 transition-all"
                    >
                      <UserIcon size={14} />
                      Technical Profile
                    </Link>
